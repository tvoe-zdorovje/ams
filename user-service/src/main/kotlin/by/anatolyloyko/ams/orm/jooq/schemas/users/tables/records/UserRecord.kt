...
open class UserRecord private constructor() : UpdatableRecordImpl<UserRecord>(User.USER), Record5<Long?, String?, String?, String?, String?> {
    ...
    override fun field5(): Field<String?> = User.USER.IDP_UUID
    ...
    override fun values(value1: Long?, value2: String?, value3: String?, value4: String?, value5: String?): UserRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long, firstName: String, lastName: String, phoneNumber: String, idpUuid: String? = null): this() {
        this.id = id
