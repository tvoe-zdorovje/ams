...
BEGIN
    ...
    SELECT users.save_user(null, initial_first_name, initial_last_name, initial_phone_number) INTO actual_generated_id;
    ...
    PERFORM users.save_user(actual_generated_id, updated_first_name, updated_last_name, updated_phone_number);
