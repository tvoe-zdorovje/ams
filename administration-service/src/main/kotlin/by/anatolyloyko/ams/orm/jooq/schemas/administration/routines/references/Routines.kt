...
import by.anatolyloyko.ams.orm.jooq.schemas.administration.routines.AssetRolesBelongTo
...
/**
 * Call <code>administration.asset_roles_belong_to</code>
 */
fun assetRolesBelongTo(
      configuration: Configuration
    , iOrganizationId: Long?
    , iRoles: Array<Long?>?
): Unit {
    val p = AssetRolesBelongTo()
