...
open class User(
    ...
    companion object {
        ...
        /**
         * The reference instance of <code>administration.user</code>
         */
        val USER: User = User()
    }
    ...
    /**
     * The column <code>administration.user.id</code>.
     */
    ...
    /**
     * Create an aliased <code>administration.user</code> table reference
     */
    ...
    /**
     * Create a <code>administration.user</code> table reference
     */
